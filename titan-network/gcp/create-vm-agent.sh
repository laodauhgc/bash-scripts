...
create_vms(){
    ...
    for project_id in $projects; do
        ...
        for zone in "${zones[@]}"; do
            ...
            --create-disk=auto-delete=yes,boot=yes,device-name="$device_name",image=projects/ubuntu-os-cloud/global/images/ubuntu-2204-jammy-v20250128,mode=rw,size=60,type=pd-ssd \
